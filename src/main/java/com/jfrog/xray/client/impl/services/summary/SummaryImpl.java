...
public class SummaryImpl implements Summary {
     ...
     * @throws IOException
     */
    private SummaryResponse postQiAn(Components components) throws IOException {
        //TODO mock数据请求结果
        return mapper.readValue(new File("D:\\work\\ide-plugins-common\\src\\test\\resources\\summary.json"), SummaryResponseImpl.class);
    }
